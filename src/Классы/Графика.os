...
Перем _ИгровыеОбъекты;

&Желудь
Процедура ПриСозданииОбъекта(&Пластилин ИгровыеОбъекты)

	_ИгровыеОбъекты = ИгровыеОбъекты;
...
Функция Цвет(Красный, Зеленый, Синий) Экспорт
	Возврат Интерфейс.Цвет(Красный, Зеленый, Синий);	
КонецФункции

Процедура ОтрисоватьЭкран() Экспорт
	
	ИгровыеОбъекты = _ИгровыеОбъекты.СортированныйСписокОбъектов("СлойОтрисовки");
        ...
        Если ТекущийОбъект.Видимость = Истина Тогда
			...
			Если НЕ КартинкаОбъекта = Неопределено Тогда
				Холст.РисоватьИзображение(КартинкаОбъекта,
										ТекущийОбъект.Позиция.Х, 
										ТекущийОбъект.Позиция.У, 
            ...
            Если ТекущийОбъект.ОтображатьГраницы = Истина Тогда
                ...
                Холст.РисоватьПрямоугольник(Перо, ТекущийОбъект.Позиция.Х-1, 
                                                    ТекущийОбъект.Позиция.У-1, 

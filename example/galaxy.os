...
Процедура ИнициализироватьИгру()
	...
	Персонаж.УстановитьАнимацию(КартинкаКорабль, 5);
...
Процедура Персонаж_ВыпуститьПулю() Экспорт;
	Пуля = Игра.ДобавитьИгровойОбъект("Пуля", 2);
	Пуля.ОтображатьГраницы = Ложь;
	...
	Игра.ДобавитьОтложенноеИгровоеСобытие(Новый Действие(Пуля, "ВыполнитьДействие"),0,"Пуля_Лететь");
...
Процедура Пуля_Лететь(ЭтаПуля) Экспорт
	...
	Игра.ДобавитьОтложенноеИгровоеСобытие(Новый Действие(ЭтаПуля, "ВыполнитьДействие"),0,"Пуля_Лететь");
КонецПроцедуры
